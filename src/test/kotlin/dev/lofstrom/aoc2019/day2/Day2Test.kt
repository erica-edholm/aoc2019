...
class Day2Test {
  ...
  fun `should execute intcode program`() {
    assertThat(computer.executeIntCode(exampleInput1)).isEqualTo(exampleOutput1a);
    assertThat(computer.executeIntCode(exampleInput2)).isEqualTo(exampleOutput2a);
    assertThat(computer.executeIntCode(exampleInput3)).isEqualTo(exampleOutput3a);
    assertThat(computer.executeIntCode(exampleInput4)).isEqualTo(exampleOutput4a);
  }
